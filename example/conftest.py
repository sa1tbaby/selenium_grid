...
def browser(request):
    """
    Returns all browsers to test_exmp with
    """
...
def pytest_runtest_logstart(nodeid, location):
    """ signal the start of running a single test_exmp item.
...
def pytest_addoption(parser):
    ...
    parser.addoption(
        ...
        dest='host',
        help=f'''Base URL of the host to test_exmp. By default "{settings.config.host}". 
